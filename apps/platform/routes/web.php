...
Route::middleware(['auth', 'verified.phone'])->group(function (): void {
    ...
    Route::middleware('tenant.area')->group(function (): void {
        ...
        Route::middleware('subscription.active')->group(function (): void {
            ...
            Route::post('/templates/{templateUlid}/versions', [TemplatesPageController::class, 'addVersion'])->name('templates.version');
            ...
            Route::delete('/team/invites/{inviteUlid}', [TeamPageController::class, 'cancelInvite'])->name('team.invite.cancel');
            Route::delete('/team/members/{memberId}', [TeamPageController::class, 'removeMember'])->name('team.member.remove');
